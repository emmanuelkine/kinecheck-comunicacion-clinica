window.KINECHECK_ACADEMY_CONFIG = Object.freeze({
  ...
  courses: [
    ...
    { slug: "evidencia-aplicada", title: "KineCheck Evidencia Aplicada", subtitle: "Razonamiento clínico con evidencia", productId: "8208817", icon: "EA", status: "active", url: "https://emmanuelkine.github.io/kinecheck-evidencia-aplicada/?v=20260728-5" },
...
(() => {
  const PRODUCT_META = {
    ...
    EA: { category: "course", label: "CURSO CLÍNICO", isNew: true },
