(() => {
  ...
  function installCatalogIntro() {
    ...
    note.innerHTML = "<strong>Primero conoce el producto.</strong> Cada ficha explica propósito, contenidos, público, vigencia, precio base y forma de acceso antes de llevarte al checkout de Hotmart.";
