(() => {
  ...
  const PRODUCTS = Object.freeze({
    "kinecheck-clinico": {
      ...
      description: "Curso profesional avanzado con una guía digital complementaria para practicar evaluación, seguridad, hipótesis, razonamiento probabilístico y reevaluación sin sustituir la ficha clínica institucional.",
      audience: "Kinesiólogos titulados y profesionales de rehabilitación musculoesquelética que buscan profundizar su evaluación y razonamiento clínico.",
      audiences: ["Kinesiólogos titulados", "Profesionales de rehabilitación musculoesquelética", "Docentes clínicos"],
      checkout: "https://pay.hotmart.com/L106791841D",
      outcomes: [
        ["Evaluación estructurada", "Conecta historia, seguridad, examen, medición e hipótesis."],
        ["Seguridad clínica", "Integra triage, banderas, criterios de derivación y límites del manejo kinésico."],
        ["Razonamiento probabilístico", "Interpreta pruebas y hallazgos según su utilidad diagnóstica y contexto."],
        ["Reevaluación", "Compara resultados y mantiene las decisiones abiertas a revisión."],
        ["Práctica educativa", "Utiliza casos ficticios, simulados o debidamente anonimizados."],
        ["Curso + guía", "El curso es el centro y la guía digital complementaria apoya el repaso."],
      ],
      contents: [
        ["Evaluación y contexto", "Historia, función, irritabilidad, carga y expectativas dentro de casos educativos."],
        ["Seguridad y complejidad", "Banderas clínicas, precauciones, límites y necesidad de derivación."],
        ["Examen y medición", "Movimiento, fuerza, desempeño, examen neurológico y neurodinámica."],
        ["Hipótesis y probabilidad", "Integración de hallazgos, utilidad diagnóstica y diagnóstico diferencial."],
        ["Reevaluación", "PROMs, cambios clínicos y decisiones revisables."],
      ],
      disclaimer: "Producto educativo. No ingreses datos reales identificables de pacientes; no sustituye la ficha clínica institucional, la evaluación profesional ni el juicio clínico.",
      faq: [
        ["¿Puede usarse como ficha clínica?", "No. Utiliza exclusivamente casos ficticios, simulados o debidamente anonimizados y documenta la atención en el sistema institucional correspondiente."],
        ["¿El curso toma decisiones por mí?", "No. Enseña a organizar e interpretar información, pero la evaluación y las decisiones corresponden al profesional."],
      ],
    },
